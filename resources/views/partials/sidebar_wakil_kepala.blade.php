...
{{-- ── Tugas Guru (karena waka juga guru) ── --}}
<div class="nav-group">
    <div class="nav-group-header {{ $ag==='guru'?'open':'' }}" onclick="toggleGroup(this)">
        <i class="bi bi-person-workspace nav-gi"></i><span class="nav-gl">Tugas Guru</span><i class="bi bi-chevron-down nav-gc"></i>
    </div>
    <div class="nav-group-body {{ $ag==='guru'?'open':'' }}">
        <div class="nav-item"><a href="{{ route('guru.jurnal.index') }}" class="{{ request()->is('guru/jurnal*')?'active':'' }}"><i class="bi bi-book"></i> Jurnal Mengajar</a></div>
        <div class="nav-item"><a href="{{ route('guru.absensi.index') }}" class="{{ request()->is('guru/absensi*')?'active':'' }}"><i class="bi bi-person-check"></i> Absensi Siswa</a></div>
    </div>
</div>
